...
# ======================
def extract_and_match_color(all_c_values, color_sheet_path="P4C_all_trans_AI.xlsx"):
...
def main():
    ...
    try:
        main_df = pd.read_excel(
            "P4C_all_trans_AI.xlsx",
            sheet_name=0,
            header=None,
            usecols=[0, 1, 2]
        )
    except FileNotFoundError:
        print("❌ 文件 'P4C_all_trans_AI.xlsx' 未找到！")
        return
    ...
    try:
        color_df = pd.read_excel("P4C_all_trans_AI.xlsx", sheet_name="COLOR", header=None, usecols=[0, 1])
